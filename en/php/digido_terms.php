...
<h1 class="h1">User agreement and terms of service</h1>
<h2>DONATION</h2>
<div class="_text">
...
Offers are saved in our database for 40 days. If a client complains about an inaccurate donation during this time, the donor’s account can be deleted.
...
donation during this time, we reserve the right to take the shipper to court for “Offense of deception on goods”. After this delay, this is all between the shipper and the client.
In case of problems with the products or the delivery, DigiDo is never responsible.
...
When the offer is a massive sale, we check all the products to see if they fit with their description. If not, we reserve the right to cancel every transaction.
</div>
</section>